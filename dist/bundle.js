(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('path'), require('js-yaml')) :
    typeof define === 'function' && define.amd ? define(['fs', 'path', 'js-yaml'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.bundle = factory(global.fs, global.path, global.yaml));
}(this, (function (fs, path, yaml) { 'use strict';
